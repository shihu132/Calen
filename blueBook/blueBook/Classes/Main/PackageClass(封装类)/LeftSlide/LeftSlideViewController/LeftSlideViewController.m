...
#pragma mark -- 通知切换主控制器-石虎
- (void)setNotiSelectedManVc
{
    //主控制
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(selectedManController) name:@"SHBaseClassViewController" object:nil];
